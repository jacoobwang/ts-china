    ...
    a.fn.fullpage = function (c) {
        ...
        function ga(b) {
            ...
            if (!Q(b.target) && (b = a(".fp-section.active"), !t && !q))
                if (d = R(d), y = d.y, B = d.x, b.find(".fp-slides").length && Math.abs(C - B) > Math.abs(z - y)) Math.abs(C - B) > a(window).width() / 100 * c.touchSensitivity && (C > B ? a.fn.fullpage.moveSlideRight() : a.fn.fullpage.moveSlideLeft());
        ...
        function p(b) {
            if (c.autoScrolling) {
                ...
                if (!t)
                    if (d = d.find(".fp-slides").length ? d.find(".fp-slide.active").find(".fp-scrollable") : d.find(".fp-scrollable"), 0 > b)
                        if (0 < d.length)
                            if (D("bottom", d)) a.fn.fullpage.moveSectionDown();
                            else return !0;
                else a.fn.fullpage.moveSectionDown();
        ...
        function l(b, d, e) {
            ...
            if ("undefined" !== typeof g) {
                ...
                c.css3 && c.autoScrolling ? (a.isFunction(c.onLeave) && !F && c.onLeave.call(this, q, r + 1, m), V("translate3d(0px, -" + g + "px, 0px)", !0), setTimeout(function () {
                    l();
        ...
        a.fn.fullpage.setMouseWheelScrolling = function (a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", p, {
                ...
                passive: false
            }), document.removeEventListener("wheel", p, !1)) : document.detachEvent("onmousewheel", p)
        };
        ...
        a(".fp-section").each(function (b) {
            ...
            b.length && (0 != a(".fp-section.active").index(".fp-section") || 0 == a(".fp-section.active").index(".fp-section") && 0 != b.index()) && da(b);
        ...
        a(window).resize(function () {
            M ? a.fn.fullpage.reBuild() : (clearTimeout(fa), fa = setTimeout(a.fn.fullpage.reBuild, 500))
        });
...
if (!$j('html').hasClass('touch') && !mobile_ie && (top === self)) {
    ...
    geocoder.geocode({
        ...
        if (status === google.maps.GeocoderStatus.OK) {
            ...
            var marker = new google.maps.Marker({
                ...
                icon: 'https://bridge302.qodeinteractive.com/wp-content/themes/bridge/img/pin.png',
...
var no_ajax_pages = [];
var qode_root = 'https://bridge302.qodeinteractive.com/';
var theme_root = 'https://bridge302.qodeinteractive.com/wp-content/themes/bridge/';
